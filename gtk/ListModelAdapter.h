...
/*Inherits from Gtk::TreeModel*/
class ListModelAdapter : public Gtk::TreeModel, public Glib::Object
{
    ...
    struct ItemInfo
    {
        /*the torrent's uniq id acutally*/
        int id = 0;
    ...
    */
    ...
    static Glib::RefPtr<ListModelAdapter> create(Glib::RefPtr<Gio::ListModel> const& adaptee)
    {
        return Glib::make_refptr_for_instance(
            ...
            new ListModelAdapter(adaptee, T::get_columns() /*return Torrent::Columns*/, 
                &T::get_item_id,/*Torrent::get_uniq_id()*/ &T::get_item_value/*Torrent::get_item_value()*/)
        );
    }
