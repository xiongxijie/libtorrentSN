...
ModelT is `Gio::ListModel` actually
SorterType is `TorrentSorter` who inherited from `SorterBase<Torrent>`
*/
    ...
    : Gtk::TreeModelSort(model)
{
    ...
    signal_changed_tag_ = sorter->signal_changed().connect([this, sort_func](auto /*changes --ChangeFlags*/)
                                                           { set_default_sort_func(sort_func); });
}
